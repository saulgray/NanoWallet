function EnglishProvider($translateProvider) {
    ...
    $translateProvider.translations('en', {
        ...
        TRANSFER_TRANSACTION_MOSAIC_TRANSFER: 'Currency transfer',
        TRANSFER_TRANSACTION_ATTACH_MOSAIC: 'Attach currency',
        TRANSFER_TRANSACTION_ATTACH: 'Attach',
        TRANSFER_TRANSACTION_MOSAICS_ATTACHED: 'Currencies attached',
        ...
        LINE_TX_DETAILS_MOS_ATTACHED: 'Currencies attached',
        ...
        LINE_TX_DETAILS_MOS_CREATE: 'Create currency',
        LINE_TX_DETAILS_MOS_EDIT: 'Edit currency',
        ...
        MOSAIC_DEFINITION_TITLE: 'Create a currency',
        MOSAIC_DEFINITION_NAME: 'Currency definition transaction',
        MOSAIC_DEFINITION_MULTISIG_NAME: 'Multisignature currency definition transaction',
        ...
        MOSAIC_DEFINITION_MOSAIC_PROPERTIES: 'Currency properties',
        MOSAIC_DEFINITION_REQUIRES_LEVY: 'Requires levy',
        MOSAIC_DEFINITION_LEVY_LIMITATION: 'UI-limitation: right now, only owned currencies can be used as a levy.',
        MOSAIC_DEFINITION_LEVY_SELECT_MOSAIC: 'Select levy currency',
        ...
        MOSAIC_DEFINITION_INFORMATION: 'Want more info about currencies?',
        MOSAIC_DEFINITION_INFORMATION_1: 'The maximum length for a currency name is 32 characters. Allowed characters are:',
        ...
        MOSAIC_DEFINITION_INFORMATION_4: 'The behavior of a currency can be customized by a set of properties:',
        MOSAIC_DEFINITION_INFORMATION_5: 'The supply is given in entire units of the currency, not in smallest sub-units. The initial supply must be in the range of 0 and 9,000,000,000.',
        MOSAIC_DEFINITION_INFORMATION_6: 'The divisibility determines up to what decimal place the currency can be divided into. Thus a divisibility of 3 means that a currency can be divided into smallest parts of 0.001 currencies, i.e. milli currencies is the smallest sub-unit. The divisibility must be in the range of 0 and 6.',
        MOSAIC_DEFINITION_INFORMATION_7: 'If checked, it allows a currency supply change at a later point, otherwise supply is immutable.',
        MOSAIC_DEFINITION_INFORMATION_8: 'Allow transfers of the currency among accounts other than the creator. If the property \'transferable\' is not checked, only transfer transactions having the creator as sender or as recipient can transfer currencies of that type. If checked the currencies can be transferred to and from arbitrary accounts.',
        ...
        MOSAIC_DEFINITION_INFORMATION_10: 'The currency in which the fee has to be paid. Any existing currency can be specified.',
        ...
        MOSAIC_DEFINITION_INFORMATION_15: 'The fee is specified as multiple of the percentile of the quantity that is transferred. The fee is thus linearly increasing with the transferred currency quantity.',
        MOSAIC_DEFINITION_INFORMATION_16: 'Sending currencies on the NEM blockchain requires a fee. The exact fee is calculated depending on their total number and how many are being sent during a transaction. <b>Small business currencies</b> are given a discounted flat rate of 1 XEM per currency per transfer.  These are currencies with a quantity of less than 10,000 and a divisibility of 0.',

        // EDIT MOSAIC MODULE
        MOSAIC_SUPPLY_CHANGE_TITLE: 'Change currency supply',
        MOSAIC_SUPPLY_CHANGE_NAME: 'Currency supply change transaction',
        MOSAIC_SUPPLY_CHANGE_MULTISIG_NAME: 'Multisignature currency supply change transaction',
        MOSAIC_SUPPLY_CHANGE_SELECT: 'Select currency',
        ...
        RENEW_NS_INFORMATION_4: 'If not renewed in time, all sub-namespaces and currencies created under it will be losts.',
        ...
        PORTAL_NS_TEXT: 'Namespaces are domain names. Each namespace is unique and authenticates currencies (assets) issued on it or on its subdomains.',
        PORTAL_NS_BTN: 'Create namespace',
        PORTAL_MOSAIC_TITLE: 'Currencies',
        PORTAL_MOSAIC_TEXT: 'NEM currencies are assets that expose additional properties and other features. To be able to create a currency, an account must rent at least one root namespace.',
        PORTAL_MOSAIC_BTN_1: 'Create currency',
        PORTAL_MOSAIC_BTN_2: 'Edit currency',
        ...
        EXPLORER_NAV_NSM: 'Namespaces & Currencies',
        EXPLORER_NAV_APOSTILLES: 'Apostilles',

        // EXPLORER HOME MODULE
        EXPLORER_HOME_TITLE: 'Explorer - Home',
        EXPLORER_HOME_NS: 'Your Namespaces',
        EXPLORER_HOME_MOSAICS: 'Your Currencies',
        EXPLORER_HOME_NS_MULTISIG: 'Multisig Owned Namespaces',
        EXPLORER_HOME_MOSAICS_LEVY: 'Levy currency',

        // EXPLORER NAMESPACES AND MOSAICS
        EXPLORER_NS_MOS_TITLE: 'Explorer - Namespaces and Currencies',
        EXPLORER_NS_MOS_SELECT_MOS: 'Selected Currency Details',
        ...
        APOSTILLE_MESSAGE_ADD_MOSAIC: 'Add currency',
        ...
        ALERT_INVALID_MOSAIC_NAME: 'Name of currency is invalid !',
        ALERT_MOSAIC_DESCRIPTION: 'Description of currency is invalid !',
        ALERT_GET_INCOMING_TXES_ERROR: 'An error occured while trying to fetch incoming transactions, reason: ',
        ALERT_GET_MOSAICS_DEFINITIONS_ERROR: 'Error at fetching currencies definitions, reason: ',
        ALERT_GET_SUB_NS_ERROR: 'Error at fetching currencies definitions, reason: ',
        ALERT_GET_MOSAICS_ERROR: 'Error at fetching currencies, reason: ',
        ...
        FAQ_QUESTION_3: 'Why do I already have one currency ?',
        FAQ_ANSWER_3: 'Because XEM is the default currency of the NEM blockchain, every user already has it registered to their wallet, even if their balance is 0. Its namespace is NEM and the currency name is XEM',
        ...
        FORM_MOSAIC_NAME_PLACEHOLDER: 'Currency name',
